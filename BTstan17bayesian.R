...
# observations
N <- nrow(games_17_BTstan)    # number of games in 2017
player1 <- games_17_BTstan$player1
player0 <- games_17_BTstan$player0
#for (n in 1:N) {
...
y <- games_17_BTstan$y #which team wins, from data
...
individual_posterior <-  sampling(individual_model, data = mle_model_data, pars = NA, 
         chains = 4, iter = 4000, warmup = 1000, diagnostic_file = "BTbayes17diagnostics.csv", verbose = FALSE, 
