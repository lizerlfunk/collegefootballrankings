...
individual_posterior <-  sampling(individual_model, data = mle_model_data, pars = NA, 
         chains = 4, iter = 4000, warmup = 1000, diagnostic_file = "BTbayes19diagnostics.csv", verbose = FALSE, 
