...
# observations
N <- nrow(games_16_BTstan)    # number of games in 2016
player1 <- games_16_BTstan$player1
player0 <- games_16_BTstan$player0
#for (n in 1:N) {
...
y <- games_16_BTstan$y #which team wins, from data
...
individual_posterior <-  sampling(individual_model, data = mle_model_data, pars = NA, 
         chains = 4, iter = 4000, warmup = 1000, diagnostic_file = "BTbayes16diagnostics.csv", verbose = FALSE, 
