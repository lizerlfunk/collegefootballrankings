...
ranked_players_16 <- as.data.frame(ranked_players)

ranked_players_16$ranked_players <- as.character(ranked_players_16$ranked_players)

write.csv(ranked_players_16, "BTrankings16.csv")
