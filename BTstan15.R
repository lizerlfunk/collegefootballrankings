...
ranked_players_15 <- as.data.frame(ranked_players)

ranked_players_15$ranked_players <- as.character(ranked_players_15$ranked_players)

write.csv(ranked_players_15, "BTrankings15.csv")
