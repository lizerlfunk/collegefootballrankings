...
# observations
N <- nrow(games_14_BTstan)    # number of games in 2015
player1 <- games_14_BTstan$player1
player0 <- games_14_BTstan$player0
#for (n in 1:N) {
...
y <- games_14_BTstan$y #which team wins, from data
...
individual_posterior <-  sampling(individual_model, data = mle_model_data, pars = NA, 
         chains = 4, iter = 4000, warmup = 1000, diagnostic_file = "BTbayes14diagnostics.csv", verbose = FALSE, 
