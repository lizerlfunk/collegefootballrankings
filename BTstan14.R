...
# observations
N <- nrow(games_14_BTstan)    # number of games in 2014
...
ranked_players_14 <- as.data.frame(ranked_players)

ranked_players_14$ranked_players <- as.character(ranked_players_14$ranked_players)

write.csv(ranked_players_14, "BTrankings14.csv")
