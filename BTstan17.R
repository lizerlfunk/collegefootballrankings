...
ranked_players_17 <- as.data.frame(ranked_players)

ranked_players_17$ranked_players <- as.character(ranked_players_17$ranked_players)

write.csv(ranked_players_17, "BTrankings17.csv")
