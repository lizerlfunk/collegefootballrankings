...
# parameters
K <- nrow(records_18) #number of teams
...
ranked_players_18 <- as.data.frame(ranked_players)

ranked_players_18$ranked_players <- as.character(ranked_players_18$ranked_players)

write.csv(ranked_players_18, "BTrankings19.csv")
